...
function CategoryViewModal({ categories, changeCategoryModal }) {
    ...
    <section className="category-modal category-view-modal">
      ...
      <header className="modal-header view-modal-header">
        <button
          ...
          onClick={() => changeCategoryModal({ isViewOpen: false })}
        >
      ...
      <div className="modal-body">
        <section className="modal-body__title-section">
          <div className="modal-title">카테고리 목록</div>
          <button
            className="btn-add-category"
            onClick={() => changeCategoryModal({ isViewOpen: false, isAddOpen: true })}
          >
        ...
        <section className="modal-body__category-section">
          {categories.map((category) => (
            <div
              ...
              onClick={() => changeCategoryModal({ isViewOpen: false, isEditOpen: true })}
            >
              <div
